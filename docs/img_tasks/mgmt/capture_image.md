...
DISMTools 0.8 introduces a variant of the image capture task for Full Flash Utility (FFU) files. You can access this variant by going to *Image tasks -> Image management -> Capture partitions to a FFU file...*, or by clicking the "Capture image" button and selecting the FFU option:

<p align="center">
	<img src="../../res/img_tasks/mgmt/capture_image_ffu_cmdmenu.png" />
</p>

<p align="center">
	<img src="../../res/img_tasks/mgmt/capture_image_ffu_btn.png" />
</p>

<p align="center">
	<img src="../../res/img_tasks/mgmt/capture_image_ffu.png" />
</p>

### Usage

1. Specify the source drive to capture and the destination FFU file to capture the contents to
2. Specify a name for the new Windows image and, if you want, a description