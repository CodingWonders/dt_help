...
Con DISMTools puedes obtener la información de la imagen actualmente montada, o de cualquier archivo de imagen de Windows, para ver los detalles de un índice.

_Esta acción es compatible con DISMTools 0.3.1 y posteriores._
...
También puedes guardar esta información pulsando el botón Save en la parte inferior derecha y especificando la ruta destino.
