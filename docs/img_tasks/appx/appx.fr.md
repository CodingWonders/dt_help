...
**NOTA:** esta información se basa en el empaquetado MSIX, aunque también aplica a AppX. Una visión general de MSIX está disponible [aquí](https://learn.microsoft.com/fr-fr/windows/msix/overview). Aquí nos centramos en aspectos técnicos relevantes para DISMTools.

Esta es la estructura general de un paquete AppX:

<p align="center">
	<img src="https://learn.microsoft.com/fr-fr/windows/msix/package/images/msixpackage.png" />
...
Referencia de App Installer: https://learn.microsoft.com/fr-fr/uwp/schemas/appinstallerschema/schema-root
